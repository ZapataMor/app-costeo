...
> **Actualización del 2026-09-07**: llegó la **guía metodológica del pipeline TDABC + MILP** (54 campos, 3.100 cirugías) con las fórmulas y tasas exactas del modelo. Dice que el **CIF se asigna por minuto de quirófano (420 COP/min)**, no como porcentaje del costo directo. Tras auditar el aplicativo se implementó el **motor de asignación de bolsas CIF**: el costo indirecto ya no es un factor plano sino un reparto por inductor, con exclusión automática del componente directo equivalente para no contarlo dos veces. Ver [[Costos Indirectos (CIF)]] y [[Fuente - Guia de Campos Base de Datos TDABC+MILP]].
