...
export default function RecursosHumanosIndex({
    recursos,
    roles,
    nivelesConfiabilidad,
    filtros,
}: {
    recursos: Paginado<RecursoHumanoParam>;
    roles: string[];
        ...
        <>
            ...
            <div className="flex flex-col gap-4 p-4">
                <EncabezadoListado
                    ...
                    accion={
                        <ModalFormulario
                            titulo="Nuevo recurso humano"
                            textoBoton="Nuevo recurso"
                        >
                            {(cerrar) => (
                                <RecursoHumanoForm
                    ...
                    filtros={[
                        {
                            clave: 'rol',
                            etiqueta: 'Rol',
                            opciones: opcionesDesdeValores(roles),
                        },
                        {
                            clave: 'confiabilidad',
                            ...
                            {recursos.data.map((recurso) => (
                                ...
                                >
                                    ...
                                    <td className="p-3 text-right tabular-nums">
                                        {cop(Number(recurso.salario_mensual))}
                                    </td>
                                    <td className="p-3 text-right tabular-nums">
                                        {cop(
                                            Number(
                                                recurso.prestaciones_mensuales,
                                            ),
                                        )}
                                    </td>
                                    <td className="p-3 text-right tabular-nums">
                                        {cop(
                                            Number(
                                                recurso.costos_indirectos_mensuales,
                                            ),
                                        )}
                                    </td>
                                    <td className="p-3">
                                    ...
                                    <td className="p-3 text-right whitespace-nowrap">
                                        ...
                                        >
                                            <Link
                                                href={RecursoHumanoController.edit.url(
                                                    recurso.id,
                                                )}
                                                prefetch
                                            >
                                        ...
                                        <ConfirmarEliminacion
                                            url={RecursoHumanoController.destroy.url(
                                                recurso.id,
                                            )}
