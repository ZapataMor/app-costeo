...
export default function SalasOperatoriasIndex({
    salas,
    nivelesConfiabilidad,
    filtros,
}: {
    salas: Paginado<SalaOperatoriaParam>;
        ...
        <>
            ...
            <div className="flex flex-col gap-4 p-4">
                <EncabezadoListado
                    ...
                    accion={
                        <ModalFormulario
                            titulo="Nueva sala operatoria"
                            textoBoton="Nueva sala"
                        >
                            {(cerrar) => (
                                <SalaOperatoriaForm
                            ...
                            {salas.data.map((sala) => (
                                ...
                                >
                                    ...
                                    <td className="p-3 text-right tabular-nums">
                                        {cop(Number(sala.costo_hora))}
                                    </td>
                                    <td
                                        className="max-w-56 truncate p-3 text-muted-foreground"
                                        title={(sala.equipamiento ?? []).join(
                                            ', ',
                                        )}
                                    >
                                    ...
                                    <td className="p-3 text-right whitespace-nowrap">
                                        ...
                                        >
                                            <Link
                                                href={SalaOperatoriaController.edit.url(
                                                    sala.id,
                                                )}
                                                prefetch
                                            >
                                        ...
                                        <ConfirmarEliminacion
                                            url={SalaOperatoriaController.destroy.url(
                                                sala.id,
                                            )}
