...
export default function SalasOperatoriasCreate({ nivelesConfiabilidad }: { nivelesConfiabilidad: string[] }) {
    return (
        <>
            <Head title="Nueva sala operatoria" />
            <div className="flex flex-col gap-4 p-4">
                <Heading title="Nueva sala operatoria" description="Registra una sala con su costo por hora de funcionamiento." />
                <SalaOperatoriaForm
