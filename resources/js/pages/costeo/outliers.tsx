        ...
        <>
            ...
            <div className="flex flex-col gap-4 p-4">
                ...
                <p className="text-sm text-muted-foreground">
                    ...
                    procedimiento. La línea punteada marca el límite superior
                    IQR; la línea sólida, la media.
                </p>
                    ...
                    return (
                        <Card key={grupo.procedimiento.id}>
                            <CardHeader>
                                <div className="flex flex-wrap items-center gap-2">
                                    ...
                                    {grupo.total_outliers > 0 ? (
                                        <Badge variant="destructive">
                                            {grupo.total_outliers} outlier
                                            {grupo.total_outliers > 1
                                                ? 's'
                                                : ''}
                                        </Badge>
                                    ) : (
                                ...
                                <CardDescription>
                                    n = {grupo.n} · media {cop(grupo.media)} ·
                                    desviación {cop(grupo.desviacion)} · CV{' '}
                                    {pct(grupo.coeficiente_variacion)} · límite
                                    IQR superior{' '}
