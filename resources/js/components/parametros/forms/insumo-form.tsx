                ...
                <>
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                required
                                placeholder="p. ej. Oxitocina 10 UI"
                            />
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="codigo_atc">
                                ...
                                {categoria === 'medicamento'
                                    ? '(obligatorio para medicamentos)'
                                    : '(solo medicamentos)'}
                            </Label>
                            <Input
                                id="codigo_atc"
                                name="codigo_atc"
                                defaultValue={insumo?.codigo_atc ?? ''}
                                placeholder="p. ej. H01BB02"
                                maxLength={7}
                            />
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                required
                                maxLength={20}
                                placeholder="p. ej. ampolla, unidad, par"
                            />
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                step="0.01"
                                min="0.01"
                                defaultValue={insumo?.costo_unitario ?? ''}
                                required
                            />
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Label htmlFor="activo">
                            Activo (disponible para registrar consumos)
                        </Label>
                    </div>
