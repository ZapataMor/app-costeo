                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                required
                                placeholder="p. ej. Torre de laparoscopia"
                            />
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="valor_adquisicion">
                                Valor de adquisición (COP, opcional)
                            </Label>
                            <Input
                                ...
                                step="0.01"
                                min="0"
                                defaultValue={equipo?.valor_adquisicion ?? ''}
                            />
                            <InputError message={errors.valor_adquisicion} />
                        </div>
                        <div className="grid gap-2">
                            <Label htmlFor="vida_util_anios">
                                Vida útil (años, opcional)
                            </Label>
                            <Input
                                id="vida_util_anios"
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                step="0.01"
                                min="0.01"
                                defaultValue={equipo?.costo_hora ?? ''}
                                required
                            />
