...
migrado_de: "información-contexto/Cerebro/05 - Fuentes/Fuente - Guia de Campos Base de Datos TDABC+MILP.md"
...
Documento metodológico de **agosto 2026** (v1.0) que describe los **54 campos** de la base de datos integrada de **3.100 cirugías simuladas** construida con el pipeline computacional **TDABC + MILP** del tercer objetivo de la tesis de [[cliente-y-negocio|Orlando Ruiz]].

Es la fuente más precisa que tenemos sobre **cómo debe calcular el aplicativo**: da fórmulas exactas, tasas en pesos y rangos de valores. Notas hermanas: [[Fuente - Fundamentacion Optimizacion Costos Quirurgicos La Guajira]] (el porqué del pipeline) y [[Fuente - Base de Datos 3100 Cirugias TDABC+MILP]] (el Excel resultante, hoja por hoja).
